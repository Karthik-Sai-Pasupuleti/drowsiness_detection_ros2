...
class PrimaryLLMNode(Node):
    ...
    def query_llama(self, prompt, expected_schema):
        payload = {
            "model": "llama3.1",
            "prompt": prompt,
            "stream": False,
    ...
    def evaluate_short_term(self):
        ...
        result = self.query_llama(prompt, schema=None)
    ...
    def update_history_context(self):
        ...
        if result and "summary" in result:
            ...
            with open(filepath, "w") as f:
                json.dump({"timestamp": timestamp, "10m_summary": self.current_history_context, "logs": self.ten_min_buffer}, f, indent=4)
