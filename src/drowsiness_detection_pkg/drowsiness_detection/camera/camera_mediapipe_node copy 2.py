...
class CameraMediapipeNode(Node):
    ...
    def __init__(self):
        ...
        output_path = self.video_base_dir = os.path.join("drowsiness_data", self.driver_id, "videos", "full_video.mp4")
    ...
    def process_frame(self, img_frame: np.ndarray):
        ...
        try:
            ...
            # Write frame to video (stream directly to disk)
